...
formatter.match({
  "location": "Login.click_on_login_butoon()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "user enter admin and admin456",
  "keyword": "When "
});
formatter.match({
  "location": "Login.user_enter_username_and_password(String,String)"
